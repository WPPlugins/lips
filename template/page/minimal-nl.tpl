...
<ul class="lips-li-knowledge">
 ...
 {if in_array("stackexchange", $lips.x_lips.ext.providers)}
 <li class="lips-li-stackexchange">Statistieken van <a href="{$lips.x_lips.ext.stackexchange.account.link}">{$lips.x_lips.ext.stackexchange.account.display_name}</a> op <a href="{$lips.x_lips.ext.stackexchange.site.site_url}">{$lips.x_lips.ext.stackexchange.site.name}</a></li>
 {/if}
</ul>
...
{* $Id: minimal-nl.tpl 580410 2012-08-01 19:41:53Z bastb $ *}