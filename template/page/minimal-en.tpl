...
template_sample_weblink: http://www.tenberge-ict.nl/tools/wordpress/lips/wp-lips-template/english-template/
template_query: utm_source=wp-lips, utm_medium=plugin-static-min-en, utm_campaign=free-plugin
-->
<div class="wrap">
<hr />
<h2>{$lips.formattedName}</h2>
{$statics.residence} | <a href="{$lips.publicProfileUrl}">LinkedIn Profile</a>{if in_array("stackexchange", $lips.x_lips.ext.providers)} | <a href="{$lips.x_lips.ext.stackexchange.account.link}">{$lips.x_lips.ext.stackexchange.site.name} Details</a>{/if}
<hr />
...
{* $Id: minimal-en.tpl 587979 2012-08-20 21:15:08Z bastb $ *}